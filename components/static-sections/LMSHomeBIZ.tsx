    ...
    <div className="flex justify-center">
      ...
      >
          ...
          return (
            <g key={division.name}>
              ...
              <circle
                ...
                cy={nodeY}
                r={FLOW_NODE_R}
                className="fill-white stroke-biz-line"
                strokeWidth={1.5}
              />
              <Icon
                x={FLOW_NODE_CX - 11}
              ...
              <text
                ...
                y={nodeY + 5}
                className="fill-biz-ink text-[15px] font-semibold"
              >
                {division.name}
              </text>
            </g>
        ...
        <text
          ...
          y={FLOW_HUB_CY - 11}
          textAnchor="middle"
          className="fill-biz-lime font-mono text-[11px] tracking-[0.05em] uppercase"
        >
          Adoption score
        </text>
        <text
          ...
          y={FLOW_HUB_CY + 18}
          textAnchor="middle"
          className="fill-white text-[26px] font-bold tracking-[-0.02em]"
        >
          {score}%
        </text>
      </svg>
    ...
    <section id="lms" className="pt-9 pb-18 sm:pb-28">
      <PageMargin>
        <SectionHeaderHomeBIZ
          ...
          copy={
            'Satu alur yang sama, tiga tahap. Setiap tahap punya PIC dan output yang jelas — bukan cuma "kelas AI" yang selesai lalu dilupakan.'
          }
        />
        ...
        <div ref={ref} className="mx-auto max-w-245">
              ...
              return (
                <motion.div
                  ...
                  transition={{
                    ...
                    delay: shouldReduceMotion ? 0 : stage.delay,
                  }}
                >
                  ...
                  />
                  <p className="mt-3 text-[16.5px] font-semibold tracking-[-0.02em] text-white">
                    {stage.title}
                  </p>
                  <p className="mt-2 text-[13.5px] leading-[1.55] text-white/62">
                    {stage.desc}
                  </p>
                </motion.div>
              );
          ...
          <div className="mt-14 border-t border-dashed border-white/15 pt-8">
            <motion.div
              ...
              transition={{
                duration: shouldReduceMotion ? 0 : 0.5,
                delay: shouldReduceMotion ? 0 : DASHBOARD_DELAY,
              }}
            >
              <JourneyParticleFlow
                inView={inView}
            ...
            <p className="mt-4 font-mono text-[10px] text-white/45 italic">
              Ilustrasi alur &amp; skor adopsi per divisi — bukan data klien
              aktual.
            </p>
          </div>
        </div>
