  ...
  return (
    <div className="flex flex-col gap-1.5" ref={containerRef}>
      ...
      <div
        id={selectId}
        className={[
          "relative flex h-9 w-full items-center rounded-lg border bg-gray-50 px-3 text-sm transition",
          isOpen ? "border-claude ring-2 ring-claude/30" : "border-gray-300",
          disabled
      ...
      >
        ...
        <div className="flex items-center gap-2 truncate">
          ...
          <span
            className={`block truncate ${selectedOption ? "text-gray-900" : "text-gray-400"}`}
          >
        ...
        {isOpen && !disabled && (
          <div className="absolute left-0 top-full z-30 mt-2 w-full overflow-hidden rounded-lg border border-gray-200 bg-white shadow-md">
              ...
              {options.map((opt, index) => (
                <li
                  ...
                  className={`flex cursor-pointer items-center gap-2 px-3 py-2 hover:bg-claude/10 hover:text-claude ${
                    value === opt.value ? fieldOptionActiveClass : "text-gray-900"
                  }`}
                >
                  {opt.image && (
