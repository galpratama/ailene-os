    ...
    <div className="flex flex-col gap-8 items-center text-center w-full max-w-sm px-8 py-12 bg-white rounded-2xl shadow-sm">
      ...
      <div className="flex flex-col gap-3 w-full">
        <button
          onClick={() => login()}
          disabled={isLoading}
          className="inline-flex items-center justify-center gap-3 w-full h-10 px-4 text-sm font-semibold rounded-lg border border-gray-200 bg-white text-gray-800 hover:bg-gray-50 active:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition"
        >
          {isLoading ? (
